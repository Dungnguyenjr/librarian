...
public class returnhistorybook extends javax.swing.JFrame {
private String name;

    public returnhistorybook() {
        initComponents();
    ...
    private void initComponents() {
        ...
        returnhistorybook = new javax.swing.JTable();
        ...
        jLabel1.setText("Lịch sử Trả sách cá nhân");

        jLabel21.setFont(new java.awt.Font("Times New Roman", 0, 36)); // NOI18N
        jLabel21.setText("Bạn đã trả tổng cộng :");

        returnhistorybook.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        returnhistorybook.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        returnhistorybook.setRowHeight(25);
        returnhistorybook.setSelectionBackground(new java.awt.Color(102, 255, 102));
        returnhistorybook.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                returnhistorybookMouseClicked(evt);
            }
        });
        jScrollPane4.setViewportView(returnhistorybook);
    ...
    private void returnhistorybookMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_returnhistorybookMouseClicked
        try {
            ...
            ResultSet rs1 = St1.executeQuery("SELECT * FROM givebookback WHERE Idrt IN (SELECT id FROM student WHERE Name = '" + this.name + "')");
            ...
            returnhistorybook.setModel(tableModel); // Set table model after iterating through result set
    ...
    }//GEN-LAST:event_returnhistorybookMouseClicked
    ...
    private void displayuserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_displayuserActionPerformed
        try {
            ...
            PreparedStatement ps1 = Con.prepareStatement("SELECT COUNT(*) AS count FROM givebookback WHERE Idrt IN (SELECT id FROM student WHERE Name = ?)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(returnhistorybook.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new returnhistorybook().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable returnhistorybook;
